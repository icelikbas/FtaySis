...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 02 Nis 2025, 16:55:09
...
INSERT INTO `drivers` (`id`, `name`, `surname`, `identity_number`, `license_number`, `primary_license_type`, `license_issue_date`, `license_expiry_date`, `phone`, `email`, `address`, `status`, `created_at`) VALUES
(1, 'Ahmet', 'Yılmaz', '12345678910', 'B123456', 'B', '2015-05-15', '2025-05-15', '5551234567', 'ahmet@example.com', 'Beşiktaş, İstanbul', 'Aktif', '2023-03-22 08:00:00'),
(2, 'Mehmet', 'Demir', '12345678911', 'E234567', 'CE', '2017-08-22', '2027-08-22', '5552345678', 'mehmet@example.com', 'Kadıköy, İstanbul', 'Aktif', '2023-03-22 08:30:00'),
(3, 'Ayşe', 'Kaya', '12345678912', 'B345678', 'B', '2017-01-05', '2027-01-05', '5553456789', 'ayse@example.com', 'Şişli, İstanbul', 'İzinli', '2023-03-22 09:00:00'),
(4, 'Fatma', 'Çelik', '12345678913', 'B456789', 'B', '2019-11-12', '2029-11-12', '5554567890', 'fatma@example.com', 'Üsküdar, İstanbul', 'Aktif', '2023-03-22 09:30:00'),
(5, 'Ali', 'Yıldız', '12345678914', 'E567890', 'D', '2015-09-18', '2025-09-18', '5555678901', 'ali@example.com', 'Beyoğlu, İstanbul', 'Aktif', '2023-03-22 10:00:00'),
(6, 'Mustafa', 'Şahin', '12345678915', 'C678901', 'C', '2018-04-30', '2028-04-30', '5556789012', 'mustafa@example.com', 'Bakırköy, İstanbul', 'Aktif', '2023-03-22 10:30:00'),
(7, 'Zeynep', 'Öztürk', '12345678916', 'B789012', 'B', '2016-12-01', '2026-12-01', '5557890123', 'zeynep@example.com', 'Ataşehir, İstanbul', 'Aktif', '2023-03-22 11:00:00'),
(8, 'Hüseyin', 'Aydın', '12345678917', 'E890123', 'CE', '2016-02-20', '2026-02-20', '5558901234', 'huseyin@example.com', 'Maltepe, İstanbul', 'Aktif', '2023-03-22 11:30:00'),
(9, 'ismail', 'çelikbaş', '40574073114', 'DE258556', 'A', '0000-00-00', '0000-00-00', '5552552525', 'ismailcelikbas66@gmail.com', 'Yozgat Merkez', 'Aktif', '2025-04-02 11:09:00'),
(10, 'SEHER', 'EROL', '58584445666', 'DE885554', 'B', '0000-00-00', '0000-00-00', '255551223', 'seher@bb.com', 'yeni şöför', 'Aktif', '2025-04-02 11:21:47'),
(12, 'abc', 'abc', '45555555555', 'EDA455454', 'M', '0000-00-00', '0000-00-00', '4455552211', 'aaaa@bb.com', 'aaaa', 'Aktif', '2025-04-02 11:52:11'),
(13, 'deneme2', 'deneme3', '11111111111', 'DE55444545', 'B', '0000-00-00', '0000-00-00', '2553691212', 'aba@bb.com', '', 'Aktif', '2025-04-02 12:05:05'),
(14, 'sevval', 'deneme', '55555555555', 'DE112444', 'A', NULL, NULL, '3232225512', 'abx@bb.com', 'Yozgat Merkez', 'Aktif', '2025-04-02 12:12:14');
...
(1, 1, 1, '145255', '2002-05-09', '2025-05-09', 'MİLLİ EĞİTİM', '', '2025-04-02 13:16:32', '2025-04-02 13:16:32'),
...
INSERT INTO `vehicles` (`id`, `plate_number`, `brand`, `model`, `year`, `vehicle_type`, `status`, `created_at`) VALUES
(1, '34 ABC 123', 'Mercedes', 'Sprinter', 2020, 'Otomobil', 'Aktif', '2023-03-20 13:00:00'),
(2, '34 DEF 456', 'Ford', 'Transit', 2019, 'Kamyonet', 'Aktif', '2023-03-20 13:30:00'),
(3, '34 GHI 789', 'Volvo', 'FH16', 2021, 'Kamyon', 'Pasif', '2023-03-20 14:00:00'),
(4, '34 JKL 012', 'Renault', 'Clio', 2022, 'Otomobil', 'Aktif', '2023-03-21 09:00:00'),
(5, '34 MNO 345', 'Toyota', 'Corolla', 2022, 'Otomobil', 'Aktif', '2023-03-21 10:00:00'),
(6, '34 PQR 678', 'Mercedes', 'Travego', 2018, 'Otobüs', 'Bakımda', '2023-03-21 11:00:00'),
(7, '34 STU 901', 'Volvo', '9700', 2019, 'Otobüs', 'Aktif', '2023-03-21 12:00:00'),
(8, '34 VWX 234', 'Scania', 'R450', 2020, 'Kamyon', 'Aktif', '2023-03-21 13:00:00'),
(9, '34 YZA 567', 'MAN', 'TGX', 2021, 'Kamyon', 'Pasif', '2023-03-21 14:00:00'),
(10, '34 BCD 890', 'Ford', 'Courier', 2022, 'Kamyonet', 'Aktif', '2023-03-21 15:00:00'),
(11, 'EX-32', 'CATEPİLLER', '336D', 2020, 'Kamyonet', 'Aktif', '2025-04-02 07:56:54');
